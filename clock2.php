        ...
        function addNull(name,num){
            ...
            for(i=0; i<6; i++){
                ...
                if(arr[i] == 1){
                    ...
                    document.getElementById(name + i).innerHTML = "<br>" + binn[i];
                    document.getElementById(name + i).style = "background-color:blue; text-align:center;";
                }else{
                    document.getElementById(name + i).innerHTML = "<br>&nbsp;";
